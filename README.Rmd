...
`r badge_devel("yanpd01/ggsector", "#4c1")`
...
`r badger::badge_custom("Windows", "passing", "#4c1")`
`r badger::badge_custom("Linux", "passing", "#4c1")`
<!-- badges: end -->
...
`help(package = "ggsector")` or `?geom_sector`after installation to view it.
There are detailed case descriptions about the usage.
